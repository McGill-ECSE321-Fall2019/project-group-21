...
<html lang="en">
  ...
  <div class="jumbotron jumbotron-fluid">
    <div class="container">
      ...
      <p
        class="lead"
      >Gallery of all Rooms, click on the name of any room to access and manage its profile.</p>
    </div>
    <button type="button" class="btn btn-primary" id="btn">Add a Room</button>
  </div>
