 ...
 */
     ...
     * @param currentEmail: email address of the student that we will update his/her information
     ...
     * @param currentEmail: email address of the student that we will update his/her password
     * @param Password: new password
     * @exception NullPointerException if student does not exist
     * @exception InvalidParameterException if any of the previous parameters equals to null or 
     * the string length equals to zero
   ...
   studentNotExisted(currentEmail);
     ...
     * @param currentEmail: email address of the student that we will update his/her first name
     ...
     * @param currentEmail: email address of the student that we will update his/her last name
     * @param LastName: new last name
     * @exception NullPointerException if student does not exist
     * @exception InvalidParameterException if any of the previous parameters equals to null or 
     * the string length equals to zero
 ...
 */
    ...
    */
    private boolean incorrectStudentDetails(String FirsName, String LastName, String Email, String PhoneNumber, String Password) {
